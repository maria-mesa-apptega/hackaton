...
const serverlessConfiguration: AWS = {
  ...
  functions: {
    ...
    ask: {
      handler: 'dist/functions/compliance/ask.handler.handler',
    ...
    history: {
      handler: 'dist/functions/compliance/history.handler.handler',
    ...
    conversation: {
      handler: 'dist/functions/compliance/conversation.handler.handler',
    ...
    // AI functions
    bedrockProcess: {
      handler: 'dist/functions/ai/bedrock.handler.handler',
    ...
    modelsInfo: {
      handler: 'dist/functions/ai/models.handler.handler',
    ...
    // Health check
    ping: {
      handler: 'dist/functions/health/ping.handler.handler',
